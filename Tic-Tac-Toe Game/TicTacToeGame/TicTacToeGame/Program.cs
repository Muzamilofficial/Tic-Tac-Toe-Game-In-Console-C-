...
namespace TicTacToeGame
{
    class Program
    {
        ...
        {
            Console.Title = "MK TIC TAC TOE GAME(SIMPLE GAME)";
            Console.BufferHeight = 100;
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("\n\n\t\t\t\t\t(A SIMPLE GAME CREATED BY MK TEAM)");
            Console.ResetColor();
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("\n\n\n\t\t\t\t\t WELCOME TO MK TIC TAC TOE GAME");
            ...
            Console.WriteLine("\n\n\n\t\t\tPlayers are represented with a unique signature" + "\n\t\t\tPlayer 1 = O.  Player 2 = X");
